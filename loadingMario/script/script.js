...
const loop = setInterval(() => {
  ...
  if (pipePosition <= 120 && pipePosition > 0 && marioPosition < 80) {
    ...
    mario.src = "images/mario-dead.png"; // troca a imagem do mario para a imagem de morte
    mario.style.width = "75px"; // diminui a largura do mario para 75px
    mario.style.marginLeft = "80px"; // diminui a margem esquerda do mario 

    startGame.src = "images/gameover.png"; // troca a imagem do start game para a imagem de game over
